...
import (
	...
	"github.com/woodleighschool/woodgate/internal/api/middleware"
...
// AppRoutes contains the browser session, protected API, and raw transfer surfaces.
...
func newBrowserRoutes(
	...
	apis := newAppAPIs(passwordLogin, ordinary, options.Version)
