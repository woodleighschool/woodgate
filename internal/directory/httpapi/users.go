...
type userListInput struct {
	...
	AccessEnabled api.OptionalParam[bool] `query:"access_enabled,omitempty"`
...
// Authorizer is the permission boundary used by directory HTTP operations.
type Authorizer interface {
	Can(context.Context, int64, authorization.Resource, authorization.Access) (bool, error)
}
...
func registerAPI(
	...
	registerListUserDepartments(humaAPI, userService, authorizer, logger)
...
func (i userListInput) params() directory.UserListParams {
	return directory.UserListParams{
		...
		AccessEnabled: i.AccessEnabled.Pointer(),
		Source:        i.Source,
		GroupID:       i.GroupID,
	}
}
...
func registerListUsers(
	...
	huma.Register(humaAPI, authorization.Require(humaAPI, authorizer, "users", authorization.View, huma.Operation{
...
func registerListUserDepartments(
	humaAPI huma.API,
	userService *directory.UserService,
	authorizer Authorizer,
	logger *slog.Logger,
...
func registerCreateUser(
	...
	huma.Register(humaAPI, authorization.Require(humaAPI, authorizer, "users", authorization.Edit, huma.Operation{
