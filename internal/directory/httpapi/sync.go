...
func registerDirectorySync(
	...
	huma.Register(humaAPI, authorization.Require(humaAPI, authorizer, "directory", authorization.View, huma.Operation{
	...
	huma.Register(humaAPI, authorization.Require(humaAPI, authorizer, "directory", authorization.Edit, huma.Operation{
