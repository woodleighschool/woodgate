...
// Location controls one check-in workflow.
type Location struct {
	...
	Groups             []directory.GroupSummary `json:"groups" nullable:"false"`
...
// PersonSummary is the directory projection attached to a check-in.
...
// LocationSummary is the location identity attached to a check-in.
...
// CheckinCreate contains the submitted event fields.
