...
On an unpaired device, choose **Set Up**, select **Manual**, and pair with the URL printed by Wrangler and the Station key `testing123`. The mock uses synthetic people and discards check-ins.
