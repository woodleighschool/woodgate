...
import { permissionLevel } from "@features/authz/permissions";
        ...
        {account.effective_permissions ? (
          <section className="flex max-w-3xl flex-col gap-3 border-t pt-6">
            <div className="flex flex-col gap-1">
              <h2 className="text-base font-semibold">Effective Permissions</h2>
              <p className="text-sm text-muted-foreground">
                Type-wide access currently granted to this account.
              </p>
            </div>
