...
import { can } from "@woodleighschool/authz";
import { ChevronRight, ChevronsUpDown, LogOut, ShieldCheck, User as UserIcon } from "lucide-react";
      ...
      <SidebarMenuItem>
        <SidebarMenuButton size="lg" render={<Link to={to} />}>
          ...
          <div className="grid flex-1 text-left text-sm/tight">
            <span className="truncate font-semibold">Woodgate</span>
      ...
      <SidebarMenuItem>
        <DropdownMenu>
          ...
          >
            ...
            <DropdownMenuSeparator />
            <DropdownMenuGroup>
              {can(account.data?.effective_permissions, "authz.roles", "view") ? (
                <DropdownMenuItem render={<Link to="/roles" />}>
                  <ShieldCheck />
                  Roles
                </DropdownMenuItem>
              ) : null}
