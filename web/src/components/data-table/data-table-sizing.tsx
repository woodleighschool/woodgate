...
export function DataTableResizeHandle<TData extends DataTableRowData, TValue>({
  ...
  return (
    <Button
      ...
      className="absolute inset-y-0 right-0 z-10 h-auto w-2 translate-x-1/2 cursor-col-resize touch-none rounded-none border-0 p-0 select-none hover:bg-transparent active:translate-y-0"
    >
      <span
        className={cn(
