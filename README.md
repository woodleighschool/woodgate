...
The companion app is configured once by QR code with the server URL and a Station secret. The server binds each Station to a location. We distribute it as a private Custom App through Apple School Manager and our MDM.
